    ...
    <div>
      <header className="fixed bg-base-300 shadow-2xl shadow-neutral inset-x-0 top-0 z-50">
        ...
        >
          ...
          <div className="hidden lg:flex lg:gap-x-12 center">
            {navigation.map((item) => (
              <div key={item.name}>
                <Link
                  to={item.id}
          ...
          >
            <div className="grid justify-center items-center">
              <img
                src={pfp}
                alt="Urja Thakur"
                className="w-72 rounded-full ring-4 ring-purple-500 ring-offset-4 ring-offset-base-100 shadow-2xl animate-shadow-pop"
              />
            </div>
            <div className="grid justify-center items-center mt-3">
              <div className="text-center">
                {/* <div className="text-2xl tracking-tight sm:text-3xl text-white">
                  Hello, I'm
                </div> */}
              </div>
              <div className="text-center">
                <h1 className="text-4xl font-extrabold tracking-tight sm:text-8xl 200">
                  <span className="text-white">Hi, I'm </span>
                  <span className="text-purple-400">Urja</span>
                </h1>
                ...
                <div className="mt-10 flex items-center justify-center gap-x-6 text-gray-300">
                  <p>
                    A Software Engineer based in India, specializing in building scalable enterprise applications using Java, Spring Boot, and React, with a focus on performance optimization and real-world problem-solving.
                  </p>
                </div>
                <div className="mt-10 flex items-center justify-center gap-x-4">
                  <button className="btn btn-outline btn-square">
                    <a
                      href="https://www.linkedin.com/in/urjathakur12/"
                      target="_blank"
                  ...
                  <button className="btn btn-outline btn-square">
                    <a
                      href="https://github.com/urjathakur12"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="btn btn-outline btn-square"
                    >
                      <svg
                        href="//github.com/urjathakur12"
                        className="h-8 w-8"
                        fill="white"
                        viewBox="0 0 16 16"
                      >
                  ...
                  <button className="btn btn-outline btn-square">
                    <a
                      href="https://leetcode.com/u/missurja/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="btn btn-outline btn-square"
                    >
